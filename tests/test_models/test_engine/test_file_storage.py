#!/usr/bin/python3
"""Defines unittests for engine/files/storage models."""
import os
import json
import models
import unittest
...
class TestFileStorage_instantiation(unittest.TestCase):
    """Unittests to test instantiation of File Storage class."""
...
class TestFileStorage_methods(unittest.TestCase):
    """Unittests to test method of the File Storage class."""
    ...
    def test_new(self):
        ...
        models.storage.new(my_rev)
        self.assertIn("BaseModel." + my_bmod.id, models.storage.all().keys())
        self.assertIn(my_bmod, models.storage.all().values())
        ...
        self.assertIn("Review." + my_rev.id, models.storage.all().keys())
        self.assertIn(my_rev, models.storage.all().values())
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as f:
            save_text = f.read()
            self.assertIn("BaseModel." + my_bmod.id, save_text)
            ...
            self.assertIn("Review." + my_rev.id, save_text)
    ...
    def test_reload(self):
        ...
        self.assertIn("BaseModel." + my_bmod.id, objs)
        ...
        self.assertIn("Review." + my_rev.id, objs)
